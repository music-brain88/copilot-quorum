                        ...
                        "items": {
                            ...
                            "properties": {
                                ...
                                "context_mode": {
                                    ...
                                    "description": "How much context the task executor inherits. 'full' = all parent context (default), 'projected' = only context_brief, 'fresh' = clean slate."
                                },
                                "context_brief": {
                                    "type": "string",
...
- `"fresh"`: Clean slate, no parent context (simple tool execution)
