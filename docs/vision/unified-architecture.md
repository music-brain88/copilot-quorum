...
│  ┃ Knowledge        ┃───────→│ · · · · · · │ Content          │  │
│  ┃ 何を知っているか  ┃        │              │ 何を見せるか      │  │
│  ┃ ≈ Hyperparameters┃        │              │ Buffer · Slot    │  │
│  ┗━━━━━━━━━━━━━━━━━━┛        │              └─────────────────┘  │
│                               │                                   │
│  ┊╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌┊  emit │      how     ┊╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌┊ │
│  ┊ Context           ┊←─────│ · · · · · · ┊ Route            ┊ │
│  ┊ どう伝搬するか    ┊        │              ┊ どう流すか        ┊ │
│  ┊ ≈ Hidden State    ┊        │              ┊ Mapping · Config ┊ │
│  ┊╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌┊        │              ┊╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌┊ │
│                               │                                   │
│  ┌──────────────────┐ drive  │      where   ┌─────────────────┐  │
│  │ Workflow          │←─────→│ · · · · · · │ Surface          │  │
│  │ どこで実行するか  │        │              │ どこに出すか      │  │
│  │ ≈ Forward Pass    │        │              │ Pane · Tab       │  │
│  └──────────────────┘        │              └─────────────────┘  │
│                               │                                   │
...
**具体例: Agent("認証システム実装")**
- Backend 全層が Interaction に作用:
  - Knowledge が過去の設計パターンで Plan 生成を inform
  - Context で DiscussionGraph が emit され、HiL 状態が伝搬
  - Workflow が Task DAG 実行を drive
- TUI 全層がその結果を提示:
  - Content: Plan + ToolLog + DiscussionGraph を全て表示 (**全 Backend 層の出力**)
  - Route: Ensemble 中は複数モデル出力を分配、Solo 時は単一パスに集約
  - Surface: Agent は Progress + ToolLog ペイン、Discuss は複数モデルペイン
